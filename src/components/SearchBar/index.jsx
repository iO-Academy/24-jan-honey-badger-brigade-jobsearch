  ...
  return (
    <form onSubmit={submitSearch}>
      <div className="bg-[url('/src/assets/JobSearchHeaderBG.jpg')] bg-cover bg-center">
        <div className='flex flex-col gap-3 px-2.5 md:py-20 py-10 mx-auto w-full lg:max-w-screen-lg'>
          <h1 className='text-white text-5xl pb-5'>Find your perfect job</h1>
          <input className='rounded p-2 px-2.5 mx-auto w-full lg:max-w-screen-lg' onChange={(e) => setSearchJob(e.target.value)} type='text' id='search' placeholder='developer' />
